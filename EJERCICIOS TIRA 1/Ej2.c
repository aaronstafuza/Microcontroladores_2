...
void ptoflotante (void){
    static double count_float=0;
    double numd[3]={0,0.003377321043530,0.003377321043530};  
    double dend[3]={1,-1.618033988749895,1};          
    double X[40]={0};
    double X1[40]={0};
    double X2[40]={0};
    double Y[40]={0};
    ...
    printf("Generador senoidal => demora punto flotante: %.1f TCY\n",count_float);
}

void generador_DSP(void){
    static double count_dsp=0;
    fractional y=Q15(0);
    ...
    while(i<20){
        ...
        //a=Fract2Float(y)*1.61803; //Multiplico por el doble del valor por el que escale y multiplico por 100=1/ts para que
        //printf("%f\n",a);
        srcV1[0]=srcV1[1]; 
        srcV1[1]=srcV1[2]; 
        srcV1[2]=0; 
    ...
    printf("Generador Senoidal => Demora DSP: %.1f TCY\n",count_dsp);
}
void generador_cos(void){
    static double count_dsp=0;
    fractional yc=Q15(1);
    fractional V1[5]={Q15(0),Q15(0),Q15(1),Q15(0),Q15(0)};
    fractional V2[5]={Q15(0/1.9566),Q15(-0.001099/1.9566),Q15(0.001099/1.9566),Q15(-1/1.9566),Q15(1.9566/1.9566)};
    int i=0;
    double a;
    start=clock();    
    while(i<20){
        yc=VectorDotProduct(5,V1,V2); 
        //a=Fract2Float(yc)*1.9566; //Multiplico por el doble del valor por el que escale
        //printf("%f\n",a);
        V1[0]=V1[1]; 
        V1[1]=V1[2]; 
        V1[2]=0; 
    ...
    stop=clock();
    count_dsp=stop-start-19.0; 
    printf("Generador cosenoidal => Demora DSP: %.1f TCY\n",count_dsp);
}
